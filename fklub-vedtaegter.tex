...
\item Enhver med tilknytning til de IT og naturvidenskabelige uddannelser ved Aalborg Universitet, kan blive medlem.
	...
	\addtocounter{fpara}{-1}
	\item[\refstepcounter{fpara}\S \arabic{fpara}b] Ved fremsendelse af motiveret ansøgning, der gennemgåes af Forstyrrelsen og vurderes tilstrækkelig, kan medlemskab opnåes af studerende uden direkte tilknytning til de IT og naturvidenskabelige uddannelser ved Aalborg Universitet.

		Kravet til indholdet samt omfanget af en sådan ansøgning fastslåes af Forstyrrelsen, og bør fremgå tydeligt af udvalgte medier, såsom F-Klubbens hjemmeside.

    Ansøgeren har ikke krav på at kende årsagen. Medlemmer af F-Klubben har krav på at kende årsagen til afslag af ansøgninger, hvis Forstyrrelsen adspørges herom.
