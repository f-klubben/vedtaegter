...
\item \label{par-best} F-klubben ledes af bestyrelsen, der består
  ...
  selv med formand, næstformand, sekretær. Derudover, tildeles hvert øvrig menigt medlem en rolle som bogholder, hverver, planlægger eller drifter. Intet
  bestyrelsesmedlem kan have to hverv.

  \begin{enumerate}
    \setcounter{enumi}{1}
    \item Bestyrelsens medlemmer varetager følgende poster: 
      \begin{itemize}
        \item \textbf{Formand} har det overordnede ansvar for bestyrelsens arbejde og repræsenterer F-klubben udadtil.
        \item \textbf{Næstformand} har ansvar for frivillige, herunder at styrke samarbejdet på tværs af udvalg og sikre løbende rekruttering af frivillige, samt for at varetage formandens opgaver i dennes fravær og efter behov.
        \item \textbf{Kasserer} varetager F-Klubbens økonomi jf.\ \S \ref{par-kas}.
        \item \textbf{Sekretær} har ansvar for korrekt og aktuel information på F-Klubbens platforme, samt offentliggørelse af referater.
        \item \textbf{Bogholder} indhenter og afstemmer udvalg- og aktivitetsbudgetter og bistår kassereren efter behov.
        \item \textbf{Hverver} arbejder for rekruttering af nye medlemmer og sikrer bredde og tværfaglighed i medlemstilgangen. Herunder følger oplæg for studerende og ansatte, og samarbejde med ruskoordinatorer, mhbp. hvervning af medlemmer.
        \item \textbf{Planlægger} koordinerer F-klubbens aktiviteter tidsmæssigt og sikrer, at arrangementer kalenderføres og ikke overlapper uhensigtsmæssigt.
        \item \textbf{Drifter} sikrer den daglige drift, i samarbejde med de autonome driftsudvalg, herunder IT-, analoge systemer og varesalg, og samarbejder med relevante udvalg om driftssikring.
      \end{itemize}
  \end{enumerate}
